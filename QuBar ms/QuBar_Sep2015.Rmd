...
The implementation of Wakeley's [-@Wakeley08] formula for estimation of the relationship between *S*, *n*, and $\theta$ was only tested for sampling sizes of 2,4,8,16 and 32 as we noted instabilities in estimation at larger sample sizes.
