...
```{r 3dchunk,fig.width=12, fig.height=12, fig.show='hold', fig.align='center',echo=FALSE}
maxindivs=50
library(plot3D)
...
Remember that the input data for this single taxon included `r actual` individuals, the vertical line in plot above. NB THE DATA YOU INPUT RIGHT NOW MAY BE MIXED FOR NORTH AND SOUTH TYPES! FIX THIS INPUT FILE!
