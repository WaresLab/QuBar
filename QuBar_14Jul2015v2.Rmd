...
To evaluate the usefulness of each method, we simulated populations with Hudson's *ms* program [@Hudson2002] using the *gap* package in R [@RCoreTeam2013]. We simulated 4 populations, using three different population mutation rates ($/theta$ of 2, 10, and 20), and also considering populations with or without growth. The growth rate was modified in simulations to target a Tajima's D value (-1.0) similar to those observed in empirical data for marine invertebrates [@Wares10]. 
