...
# rearrenging levels of theta for plots
newdata1$Theta <- factor(newdata1$Theta,levels=c("two","ten","twenty"))
...
ggplot(allwak, aes(x=samplingSize, y=dif,color=Theta)) + theme_bw()+geom_point()+geom_point(position = "jitter")+geom_hline(yintercept=0)+xlab("Simulated sampling size")+ylab("Difference in simulated vs predicted sampling size") + ggtitle("Predictive method: Wakeley's likelihood")
