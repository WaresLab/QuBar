...
# We can use this trick to avoid the issue with the working directory, after you set the working directory with "To Source File Location" (if that is the same in macs)
mydir <- getwd()
setwd(mydir)
```
