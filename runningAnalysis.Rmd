...
meank->meank20; vark->vark20

# save results of each theta in a dataframe
dataSampling<-as.data.frame(cbind(c(1:maxn),meank2,vark2,meank10,vark10,meank20,vark20))
names(dataSampling)<-c("n","expHap.t2","varHap.t2","expHap.t10","varHap.t10","expHap.t20","varHap.t20")
dataSampling <- dataSampling[-1,]
row.names(dataSampling) <- NULL

# save data file
write.csv(dataSampling,"dataSamplingTheory_23Jul2015.csv")
```
...
with(dataSampling,plot(n,expHap.t20,col="red",main="Expected number of haplotypes",pch=19,ylim=c(1,50),ylab="Ex. n° haplotypes-no growth",xlab="Sampling size",type="l",lwd=2))
with(dataSampling,points(n,expHap.t10,col="blue",pch=19,type="l",lwd=2))
with(dataSampling,points(n,expHap.t2,col="black",pch=19,type="l",lwd=2))


# add points of populations with NO growth
points(twenty$samplingSize-0.5,twenty$n.haplotypes,col="red",cex=0.5,pch=19)
points(ten$samplingSize,ten$n.haplotypes,col="blue",cex=0.5,pch=19)
points(two$samplingSize+0.5,two$n.haplotypes,col="black",cex=0.5,pch=19)

# plot expected number of haplotypes + observed in simulations
with(dataSampling,plot(n,expHap.t20,col="red",main="Expected number of haplotypes",pch=19,ylim=c(1,50),ylab="Ex. n° haplotypes- growth",xlab="Sampling size",type="l",lwd=2))
with(dataSampling,points(n,expHap.t10,col="blue",pch=19,type="l",lwd=2))
with(dataSampling,points(n,expHap.t2,col="black",pch=19,type="l",lwd=2))
