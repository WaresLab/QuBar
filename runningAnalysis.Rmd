...
Now we can plot for each sampling size the expected value according Wakeley, and mark the abline with the observed value. And then do that for both theta.
